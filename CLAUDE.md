...
- **`npm run dev`** - Run TypeScript directly without compilation (uses ts-node)
...
- Use `npm run dev` for quick iteration and testing during development
- Use `npm run build` before deployment or when you need compiled JavaScript output
